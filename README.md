...
![preview](https://raw.githubusercontent.com/shubh-shukla/Portfolio/main/thumbnail.png)
...
```bash
$ git clone https://github.com/shubh-shukla/Portfolio.git
$ cd Portfolio
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/shubh-shukla/Portfolio/blob/main/LICENSE).
